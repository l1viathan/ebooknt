...
public abstract class MuPdfContext extends AbstractCodecContext {
    ...
    public static final int MUPDF_FEATURES = FEATURE_CACHABLE_PAGE_INFO | FEATURE_PARALLEL_PAGE_ACCESS
            | FEATURE_EMBEDDED_OUTLINE | FEATURE_PAGE_TEXT_SEARCH | FEATURE_POSITIVE_IMAGES_IN_NIGHT_MODE
